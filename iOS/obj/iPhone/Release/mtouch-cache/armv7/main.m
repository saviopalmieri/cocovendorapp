...
extern void *mono_aot_module_CocoVendorApp_iOS_info;
...
extern void *mono_aot_module_KeyboardOverlap_Forms_Plugin_iOSUnified_info;
...
{
	mono_aot_register_module (mono_aot_module_CocoVendorApp_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_KeyboardOverlap_Forms_Plugin_iOSUnified_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("KeyboardOverlap.Forms.Plugin.iOSUnified.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "CocoVendorApp.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
